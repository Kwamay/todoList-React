...
- [Copy & Paste] the Git clone you find in the code button git@github.com:albertkantwi/todo-app-react.git into your terminal and press [Enter]
...
- git clone git@github.com:albertkantwi/todo-app-react.git

Example commands:

```sh
  cd todo-app-react
  git clone https://github.com/Kwamay/todoList-React.git
...
Feel free to check the [issues page](https://github.com/Kwamay/todoList-React/issues).
